(self["webpackChunk_lo_vue3_web"] = self["webpackChunk_lo_vue3_web"] || []).push([[832],{
...
var defaults = {
  ...
  env: {
    FormData: __webpack_require__(5942)
  },
...
const _hoisted_5 = { class: "border pd-sm" };
...
const _hoisted_11 = { class: "w-50 mg0auto mg-t" };
const _hoisted_12 = { class: "text-light text-bold color-primary" };
const _hoisted_13 = { class: "color-title" };
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
    return ((0,external_Vue_.openBlock)(), (0,external_Vue_.createElementBlock)("div", null, [
        (0,external_Vue_.createElementVNode)("div", null, "userId:" + (0,external_Vue_.toDisplayString)(_ctx.userId), 1),
        (0,external_Vue_.createElementVNode)("div", _hoisted_1, [
            _hoisted_2,
            (0,external_Vue_.withDirectives)((0,external_Vue_.createElementVNode)("select", {
                name: "type",
                ...
                [external_Vue_.vModelSelect, _ctx.todoAdd.type]
            ]),
            _hoisted_4,
            (0,external_Vue_.withDirectives)((0,external_Vue_.createElementVNode)("input", {
                ...
                [external_Vue_.vModelText, _ctx.todoAdd.label]
            ]),
        ...
        (0,external_Vue_.createElementVNode)("div", _hoisted_5, [
            _hoisted_6,
            (0,external_Vue_.withDirectives)((0,external_Vue_.createElementVNode)("input", {
                "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => ((_ctx.listFilter.queryText) = $event))
            }, null, 512), [
                [external_Vue_.vModelText, _ctx.listFilter.queryText]
            ]),
            _hoisted_7,
            (0,external_Vue_.withDirectives)((0,external_Vue_.createElementVNode)("select", {
                name: "type",
                ...
                [external_Vue_.vModelSelect, _ctx.currType]
            ]),
            _hoisted_9,
            (0,external_Vue_.withDirectives)((0,external_Vue_.createElementVNode)("select", {
                name: "status",
                ...
                [external_Vue_.vModelSelect, _ctx.currStatus]
            ]),
            (0,external_Vue_.createElementVNode)("ul", _hoisted_11, [
                ((0,external_Vue_.openBlock)(true), (0,external_Vue_.createElementBlock)(external_Vue_.Fragment, null, (0,external_Vue_.renderList)(_ctx.list, (item, index) => {
                    return ((0,external_Vue_.openBlock)(), (0,external_Vue_.createElementBlock)("li", {
                        key: item.id,
                        class: "pd-tb-xs text-left flex-row-nowrap"
                    }, [
                        (0,external_Vue_.createElementVNode)("b", _hoisted_12, (0,external_Vue_.toDisplayString)(index + 1) + ".", 1),
                        (0,external_Vue_.createElementVNode)("span", _hoisted_13, (0,external_Vue_.toDisplayString)(item.label), 1),
                        (0,external_Vue_.createElementVNode)("span", _hoisted_14, (0,external_Vue_.toDisplayString)(item.status), 1),
                        (0,external_Vue_.createElementVNode)("span", {
                            class: "text-light",
                            style: (0,external_Vue_.normalizeStyle)({ color: item.type })
                        }, (0,external_Vue_.toDisplayString)(item.type), 5),
                        (0,external_Vue_.createElementVNode)("button", {
                            class: "mg-l",
...
;// CONCATENATED MODULE: ./src/views/Example/Todos/index.vue?vue&type=template&id=f7eda8e8&scoped=true&ts=true
/* unplugin-vue-components disabled */
...
function useFilter(list) {
    const listFilter = (0,external_Vue_.reactive)({ queryText: '', type: TYPE.DEFAULT, status: STATUS.DEFAULT });
    ...
    const listMatchFilter = (0,external_Vue_.computed)(() => {
        ...
        return list.value.filter((todo) => {
            let res = true;
            if (queryText)
                res = res && todo.label.includes(queryText);
            if (type)
                res = res && todo.type === type;
            if (status)
                res = res && todo.status === status;
            return res;
        });
    });
    return {
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/unplugin@0.9.2/node_modules/unplugin/dist/webpack/loaders/transform.js?unpluginName=unplugin-auto-import!../../node_modules/.pnpm/unplugin@0.9.2/node_modules/unplugin/dist/webpack/loaders/transform.js?unpluginName=unplugin-vue-components!../../node_modules/.pnpm/ts-loader@9.3.1_xnp4kzegbjokq62cajex2ovgkm/node_modules/ts-loader/index.js??clonedRuleSet-5.use[0]!../../node_modules/.pnpm/vue-loader@17.0.0/node_modules/vue-loader/dist/index.js??ruleSet[1].rules[10].use[0]!../../node_modules/.pnpm/loclass-style-loader@0.0.4/node_modules/loclass-style-loader/dist/index.js!./src/views/Example/Todos/index.vue?vue&type=script&lang=ts
/* unplugin-vue-components disabled */



/* harmony default export */ const Todosvue_type_script_lang_ts = ((0,external_Vue_.defineComponent)({
    props: {
        userId: {
            type: String,
            required: true,
    ...
    setup(props) {
        const { userId } = (0,external_Vue_.toRefs)(props);
...
const __exports__ = /*#__PURE__*/(0,exportHelper/* default */.Z)(Todosvue_type_script_lang_ts, [['render',render],['__scopeId',"data-v-f7eda8e8"]])

/* harmony default export */ const Todos = (__exports__);
